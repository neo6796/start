...
| **Prevádzka** | | kde človek býva — závod, farma, sklad; podľa toho sa mu vozí obed |
...
**Prevádzka je bežné pracovisko, nie výnimka.** Uveďte, kde je človek vedený. Že je občas inde, je v poriadku — to sa v aplikácii rieši na konkrétny deň a nikam sa to vopred zapisovať nemusí.
