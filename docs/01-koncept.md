...
6. ~~**Zoznam zamestnancov**~~ — **vyriešené:** menoslov je pripravený v dohodnutom tvare, **33 ľudí** (prefixy `1`, `2`, `3`). Importuje sa ako *osobné číslo · druh pomeru · priezvisko · meno*, členené hlavičkami `# --- Firma, prevádzka ---`; **neznáma firma ani prevádzka sa nezaloží**, import ich len vypíše (1.3b, rozhodnutie 37). Tím, predák a jedáleň sa dopĺňajú v appke z rozbaľovacích zoznamov. Ostáva doplniť **firmu, typ vzťahu, tím, predáka a prevádzku** ku každému — to je otázka na HR, nie na súbor.
